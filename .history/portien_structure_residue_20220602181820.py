...
def distance_in_sequence(chain, amino_acid_id1, amino_acid_id2):
    print(chain.index(amino_acid_id1))
    return abs(chain.index(amino_acid_id1) - chain.index(amino_acid_id2))
    ...
    for chain_id in protein_sequence:
        ...
        for i in range(len(protein_coordinates)):
            for j in range(i + 1, len(protein_coordinates)):
                if distance(protein_coordinates[i], protein_coordinates[j]) <= D and distance_in_sequence(protein_coordinates,protein_coordinates[i], protein_coordinates[j]) >= S:
