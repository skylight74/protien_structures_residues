...
# the following function will output the pairs in the format required by the Rosetta
#script.
def output_pairs(pairs, output_file):
    # Open the output file and write the pairs to it
