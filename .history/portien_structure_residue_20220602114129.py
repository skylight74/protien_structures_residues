...
# This function will read the PDB file and get the sequence of each chain from the SEQRES records and e. For each amino acid, you are only going to use the CA atom (alpha-Carbon) coordinates.
