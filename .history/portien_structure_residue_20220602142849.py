        ...
        if line[0:4] == 'ATOM' and line[13:16] == 'CA ':
            ...
            for chain_id in seq:
                for aa in seq[chain_id]:
                    # if the amino acid id is in the dictionary of coordinates, add the coordinates to the list
                    if aa in coords:
                        coords[aa].append(list(map(float, line[30:55].split())))
                    # if the amino acid id is not in the dictionary of coordinates, initialize the list and add the coordinates to the list
                    else:
                        coords[aa] = [list(map(float, line[30:55].split()))]
