...
def read_pdb(pdb_file):
    ...
    for line in pdb_file:
        ...
        if line[0:4] == 'ATOM' and line[13:16] == 'CA ':
            ...
            amino_acid_coordinate = [float(line[30:38]), float(line[38:46]), float(line[46:54])]
            if chain_id in seq:
                seq[chain_id].append([amino_acid_residue_name, amino_acid_coordinate])
            else:
                seq[chain_id] = [[amino_acid_residue_name, amino_acid_coordinate]]
    # close the pdb file
    pdb_file.close()
...
def main():
    ...
    print(get_protein_coordinates_in_seq('VAL', seq, 'B'))
