    ...
    with open(pdb_file, 'r') as pdb_file:
        ...
        for line in pdb_file:
            ...
            if line[0:6] == 'SEQRES':
                ...
                # Initialize the sequence of the chain.
                sequence.append([])
                # Initialize the coordinates of the amino acids.
                coordinates.append([])
                # Add the amino acid sequence to the sequence of the chain and type the amino acids as slices.
                sequence[chain_id] = amino_acid_sequence
    # Return the sequence of each chain, and the coordinates of each amino acid.
