...
def read_pdb(pdb_file):
    ...
    for line in pdb_file:
        ...
        if line[0:4] == 'ATOM' and line[13:16] == 'CA ':
            # initialize the coordinates with the residue name as the key and the coordinates as the value
            # get the amino acid residue name
            res_name = line[17:20]
            coords[res_name].append(float(line[30:38]), float(line[38:46]), float(line[46:54]))
    # close the pdb file
    pdb_file.close()
